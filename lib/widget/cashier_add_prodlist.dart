...
class ProductListScreenSupplier extends StatefulWidget {
  const ProductListScreenSupplier({super.key});

  @override
  _ProductListScreenSupplierState createState() => _ProductListScreenSupplierState();
}

class _ProductListScreenSupplierState extends State<ProductListScreenSupplier> {
